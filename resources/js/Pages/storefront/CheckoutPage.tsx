...
export default function CheckoutPage({ business, couriers, products }: CheckoutPageProps) {
    ...
    return <>
        ...
        <PublicFrame>
            ...
            <main className="px-4 pb-6 pt-4 font-sans text-[#3a2117] sm:px-5 lg:px-8 lg:pb-8 lg:pt-5">
