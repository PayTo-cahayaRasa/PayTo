...
class BusinessSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'online_order.shipping.origin' => ['required', 'string', 'max:50'],
            'online_order.shipping.packaging_weight_grams' => ['required', 'integer', 'min:0', 'max:100000'],
            'online_order.shipping.couriers' => ['required', 'array', 'min:1', 'max:3'],
            ...
            'online_order.payment.instructions' => ['required', 'string', 'max:1000'],
        ];
    }
